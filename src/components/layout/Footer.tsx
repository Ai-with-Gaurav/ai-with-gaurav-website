...
const socialLinks = [
  {
    label: "GitHub",
    href: "https://github.com/Ai-with-Gaurav",
    svg: (
  ...
  {
    label: "X (Twitter)",
    href: "https://x.com/AiwithGaurav12",
    svg: (
  ...
  {
    label: "Email",
    href: "mailto:g33227476@gmail.com",
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-3 text-sm text-text-muted max-w-xs">
              Building production AI systems — chatbots, voice assistants, RAG
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-lg bg-dark-700 text-text-muted transition-all hover:bg-primary hover:text-dark-900"
                >
                  {social.svg}
                </a>
              ))}
